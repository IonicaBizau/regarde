...
```sh
# Using npm
npm install --global regarde

# Using yarn
yarn global add regarde
```
...
Here is an example how to use this package as library. To install it locally, as library, you can use `npm install regarde` (or `yarn add regarde`):
